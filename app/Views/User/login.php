                ...
                <div class="row">
                    ...
                    <form action="<?= base_url('login-validation') ?>" method="post">
                        <div class="mb-3">
                            ...
                            <div>
                                <!-- <label for="username" placeholder="Enter username or email" >Username</label> -->
                                <input type="text" name="username" class='form-control' placeholder="<?= $StoredText['UsernamePlaceholder'] ?>" required>
                            </div>
                            <div class="text-type-1"><?= $StoredText['PasswordLabel'] ?></div>
                            <div>
                                <!-- <label for="password" placeholder="Enter password" >Password</label> -->
                                <input type="password" name="password" class='form-control' placeholder="<?= $StoredText['PasswordPlaceholder'] ?>" required>
                            </div>
                        </div>
                        <div>
                            <button class="btn btn-success text-type-2 px-5" type="submit"><?= $StoredText['LoginButton'] ?></button>

                ...
                <?php if(isset($purchase['Items'])){?>
                    <?php foreach ($purchase['Items'] as $key => $item) { ?>
                        ...
                        <tr>
                            ...
                            <td class="text-end" colspan="3"><?= number_format($item['ItemUnitPrice'],2) ?></td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                            <td>Original Item Price</td>
                            <td class="text-end" colspan="3"><?= number_format($item['ItemOriginalPrice'],2) ?></td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                            <td>Discount Item Price</td>
                            <td class="text-end" colspan="3"><?= number_format($item['ItemlDiscountAmount'],2) ?></td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                            <th>Final Item Price</th>
                            <th class="text-end" colspan="3"><?= number_format($item['ItemFinalPrice'],2) ?></th>
                        </tr>
                    <?php } ?>
                <?php } ?>
                <tr>
                    <th class=" head-type-4">Total</th>
                    <th class="text-end head-type-4"  colspan="4"><?= number_format($purchase['PurchaseTotalAmount'],2) ?></th>
                </tr>
                <tr>
                    <td></td>
                </tr>

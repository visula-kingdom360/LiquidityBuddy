...
-- Dumping data for table ooms.category_promo_link: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `promotion` (
  ...
  `TermsConditions` tinytext NOT NULL,
...
CREATE TABLE IF NOT EXISTS `screen` (
  ...
  `screen_url` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`screen_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table ooms.screen: ~3 rows (approximately)
...
-- Dumping data for table ooms.stored_text: ~28 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `stored_text_lang_map` (
  ...
  CONSTRAINT `FK_stored_text_lang_map_language` FOREIGN KEY (`lang_code`) REFERENCES `language` (`lang_code`),
  CONSTRAINT `FK_stored_text_lang_map_stored_text` FOREIGN KEY (`stored_text`) REFERENCES `stored_text` (`stored_text`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table ooms.stored_text_lang_map: ~27 rows (approximately)

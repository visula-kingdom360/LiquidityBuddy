...
CREATE TABLE IF NOT EXISTS `category` (
  ...
  `PrimaryCategory` enum('Y','N') NOT NULL DEFAULT 'N',
  PRIMARY KEY (`CategoryID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table ooms.category: ~11 rows (approximately)
/*!40000 ALTER TABLE `category` DISABLE KEYS */;
INSERT INTO `category` (`CategoryID`, `Description`, `Status`, `ParentID`, `PrimaryCategory`) VALUES
	(1, 'Food', 'A', 0, 'Y'),
	(2, 'Pizza', 'A', 1, 'N'),
	(3, 'Rice', 'A', 1, 'N'),
	(4, 'Kottu', 'A', 1, 'N'),
	...
	(9, 'Submarin', 'A', 1, 'N'),
	(10, 'Hoppers', 'A', 1, 'N'),
	(11, 'Strign Hoppers', 'A', 1, 'N'),
	(12, 'Toys', 'A', 0, 'Y'),
	(13, 'Action FIgures', 'A', 12, 'N');
/*!40000 ALTER TABLE `category` ENABLE KEYS */;

-- Dumping structure for table ooms.category_promo_link
CREATE TABLE IF NOT EXISTS `category_promo_link` (
  `category_id` int(11) NOT NULL,
  `promotion_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`promotion_id`),
  KEY `FK__promotion` (`promotion_id`),
  CONSTRAINT `FK__category` FOREIGN KEY (`category_id`) REFERENCES `category` (`CategoryID`),
  CONSTRAINT `FK__promotion` FOREIGN KEY (`promotion_id`) REFERENCES `promotion` (`PromotionID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table ooms.category_promo_link: ~3 rows (approximately)
/*!40000 ALTER TABLE `category_promo_link` DISABLE KEYS */;
INSERT INTO `category_promo_link` (`category_id`, `promotion_id`) VALUES
	(8, 5),
	(13, 6),
	(13, 7);
/*!40000 ALTER TABLE `category_promo_link` ENABLE KEYS */;
...
-- Dumping data for table ooms.corparation: ~10 rows (approximately)
...
INSERT INTO `corparation` (`CorparationID`, `Name`, `Summary`, `Description`, `BIR`, `Logo`, `Rate`, `Status`) VALUES
	...
	(9, 'Pizza Hut', 'Welcome to the official website of Pizza Hut (Sri Lanka). Call us or order online & donâ€™t forget to choose CONTACTLESS DELIVERY!', 'Pizza Hut is an American multinational restaurant chain and international franchise founded in 1958 in Wichita, Kansas by Dan and Frank Carney. They serve their signature pan pizza and other dishes including pasta, breadsticks and dessert at dine-in, take-out and delivery chain locations.', NULL, 'pizza_hut.jpg', 4.5000, 'A'),
	(10, 'Burger King', 'Get access to exclusive coupons. Discover our menu and order delivery or pick up from a Burger King near you.', 'Burger King is an American-based multinational chain of hamburger fast food restaurants. Headquartered in Miami-Dade County, Florida, the company was founded in 1953 as Insta-Burger King, a Jacksonville, Florida–based restaurant chain', NULL, 'burger_king.png', 0.0000, 'A');
/*!40000 ALTER TABLE `corparation` ENABLE KEYS */;

-- Dumping structure for table ooms.country
...
-- Dumping data for table ooms.country: ~1 rows (approximately)
...
-- Dumping data for table ooms.customer: ~2 rows (approximately)
/*!40000 ALTER TABLE `customer` DISABLE KEYS */;
INSERT INTO `customer` (`CustomerID`, `FullName`, `GPS`, `Gender`, `DOB`, `Membership`, `Status`, `UserID`) VALUES
	(1, 'Visula', '0', 'M', '1997-12-10', 'Newbie', 'A', 1),
	(2, 'Mike', '0', 'M', '2002-12-05', 'Newbie', 'A', 2);
/*!40000 ALTER TABLE `customer` ENABLE KEYS */;

-- Dumping structure for table ooms.customer_access_log
CREATE TABLE IF NOT EXISTS `customer_access_log` (
  `customer_access_log_id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_id` int(11) NOT NULL DEFAULT 0,
  `category_id` int(11) NOT NULL DEFAULT 0,
  `date` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`customer_access_log_id`) USING BTREE,
  KEY `FK_customer_category_link_category` (`category_id`),
  KEY `FK_customer_category_link_customer` (`customer_id`),
  CONSTRAINT `FK_customer_category_link_customer` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`CustomerID`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table ooms.customer_access_log: ~2 rows (approximately)
/*!40000 ALTER TABLE `customer_access_log` DISABLE KEYS */;
INSERT INTO `customer_access_log` (`customer_access_log_id`, `customer_id`, `category_id`, `date`) VALUES
	(5, 1, 2, '2022-12-05 21:37:01'),
	(6, 1, 3, '2022-12-05 21:37:08');
/*!40000 ALTER TABLE `customer_access_log` ENABLE KEYS */;
...
-- Dumping structure for table ooms.district
CREATE TABLE IF NOT EXISTS `district` (
  `district_code` char(5) NOT NULL,
  `district` varchar(50) NOT NULL DEFAULT '',
  `province_code` char(5) NOT NULL,
  PRIMARY KEY (`district_code`),
  KEY `FK__provice` (`province_code`),
  CONSTRAINT `FK__provice` FOREIGN KEY (`province_code`) REFERENCES `province` (`province_code`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table ooms.district: ~22 rows (approximately)
/*!40000 ALTER TABLE `district` DISABLE KEYS */;
INSERT INTO `district` (`district_code`, `district`, `province_code`) VALUES
	('LK-11', 'Colombo', 'LK-1'),
	('LK-12', 'Gampaha', 'LK-1'),
	('LK-13', 'Kalutara', 'LK-1'),
	('LK-21', 'Kandy', 'LK-2'),
...
-- Dumping data for table ooms.equipment: ~14 rows (approximately)
...
INSERT INTO `equipment` (`EquipmentID`, `Name`, `Highlight`, `Description`, `Status`, `Rental_Sales`, `Rate`, `CorparationID`, `Brand_AccessID`, `GenreID`) VALUES
	...
	(25, 'War Machine Mafex', 'All War Machine Marfex Action Figures', NULL, 'A', 'Both', 0.0000, 4, 4, 7);
...
-- Dumping structure for table ooms.language
...
-- Dumping data for table ooms.language: ~2 rows (approximately)
/*!40000 ALTER TABLE `language` DISABLE KEYS */;
INSERT INTO `language` (`lang_code`, `lang_desc`) VALUES
	('en', 'English'),
	('si', 'Sinhala'),
	('ta', 'Tamil');
...
-- Dumping structure for table ooms.parameter
CREATE TABLE IF NOT EXISTS `parameter` (
  `code` char(20) NOT NULL,
  `datatype` enum('int','decimal','logical','date','datetime','string') NOT NULL DEFAULT 'int',
  `value` varchar(50) NOT NULL DEFAULT '',
  `type` enum('General','Other') NOT NULL DEFAULT 'General',
  PRIMARY KEY (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;

-- Dumping data for table ooms.parameter: ~4 rows (approximately)
/*!40000 ALTER TABLE `parameter` DISABLE KEYS */;
INSERT INTO `parameter` (`code`, `datatype`, `value`, `type`) VALUES
	('attempt_expire', 'int', '3600', 'General'),
	('lock_limit', 'int', '15', 'General'),
	('login_attempts', 'int', '3', 'General'),
	('pagination_limit', 'int', '6', 'General'),
	('promo_file_path', 'string', 'assets/media/img/promo/', 'General');
/*!40000 ALTER TABLE `parameter` ENABLE KEYS */;

-- Dumping structure for table ooms.postal
CREATE TABLE IF NOT EXISTS `postal` (
  `postal_code` char(5) NOT NULL,
  `postal` varchar(50) NOT NULL DEFAULT '',
  `district_code` char(5) NOT NULL,
  PRIMARY KEY (`postal_code`),
  KEY `FK_postal_district` (`district_code`),
  CONSTRAINT `FK_postal_district` FOREIGN KEY (`district_code`) REFERENCES `district` (`district_code`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;

-- Dumping data for table ooms.postal: ~4 rows (approximately)
/*!40000 ALTER TABLE `postal` DISABLE KEYS */;
INSERT INTO `postal` (`postal_code`, `postal`, `district_code`) VALUES
	('00100', 'Colombo 01', 'LK-11'),
	('00200', 'Colombo 02', 'LK-11'),
	('00300', 'Colombo 03', 'LK-11'),
	('00400', 'Colombo 04', 'LK-11');
...
CREATE TABLE IF NOT EXISTS `promotion` (
  ...
  `MaximumValue` decimal(15,2) NOT NULL DEFAULT 0.00,
...
-- Dumping data for table ooms.promotion: ~4 rows (approximately)
/*!40000 ALTER TABLE `promotion` DISABLE KEYS */;
INSERT INTO `promotion` (`PromotionID`, `CorparationID`, `Name`, `Description`, `TermsConditions`, `DiscountType`, `DiscountValue`, `StartDate`, `EndDate`, `MinimumValue`, `MaximumValue`, `Photo`, `Link`, `Status`) VALUES
	(3, 9, 'Enjoy CYBER SAVINGS from Pizza Hut', 'Buy any 2 Large Pan Pizzas and get Rs. 600 OFF!', 'Please Note: Promotions, Deals, and Offer details are physically collected from business centers or direct submission or social media websites or web portals. Offers may change without prior notice. Please check with the respective companies before visiti', 'Amount', 0.00, '2022-11-01', '2022-11-30', 0.00, 0.00, 'pizza_hut_promo_01.jpg', 'https://www.pizzahut.lk/?utm_source=mypromo.lk&utm_medium=mypromo.lk&utm_campaign=mypromo.lk', 'A'),
	(5, 10, 'Return within 14 days and get 15% off on your tota', 'Present your previous bill to the cashier to get the discount.', 'Please Note: Promotions, Deals, and Offer details are physically collected from business centers or direct submission or social media websites or web portals. Offers may change without prior notice. Please check with the respective companies before visiting', 'Amount', 0.00, '2022-11-28', '2022-12-31', 0.00, 0.00, 'mypromo.lk-promo-24f1161dd6e14d38ad088f74ea521e0c.jpg', NULL, 'A'),
	(6, 5, 'Mr. Liberty, Alvin Greene, part of RiverDogs action figure promotion', 'With all the talk earlier this year of a “Mr. Liberty” statue at nearby Patriots Point, the RiverDogs already planned to give away miniature “Mr. Liberty” statues to the first 1,000 fans in attendance Saturday for their minor league baseball game ', 'Please Note: Promotions, Deals, and Offer details are physically collected from business centers or direct submission or social media websites or web portals. Offers may change without prior notice. Please check with the respective companies before visiti', 'Amount', 0.00, '2022-12-14', '2022-12-31', 0.00, 0.00, '58063ebb1eb6d.image.jpg', 'https://www.postandcourier.com/sports/mr-liberty-alvin-greene-part-of-riverdogs-action-figure-promotion/article_e5a6f0c9-9336-5ecf-960c-eaee6da55c71.html', 'A'),
	(7, 5, 'NECA The Predator Lab Escape Fugitive Predator Action Figure With Light-Up LED Mask Ultimate Action ', 'NECA The Predator Lab Escape Fugitive Predator Action Figure With Light-Up LED Mask Ultimate Action Figure Toys Promotion Price', 'Please Note: Promotions, Deals, and Offer details are physically collected from business centers or direct submission or social media websites or web portals. Offers may change without prior notice. Please check with the respective companies before visiti', 'Amount', 0.00, '2022-12-14', '2022-12-31', 0.00, 0.00, '8589ea5bb52dce7840d35af5308894e2.jpg', 'https://www.daraz.lk/products/neca-the-predator-lab-escape-fugitive-predator-action-figure-with-light-up-led-mask-ultimate-action-figure-toys-promotion-price-i134372728-s1053053723.html?', 'A');
/*!40000 ALTER TABLE `promotion` ENABLE KEYS */;

-- Dumping structure for table ooms.promotion_province
CREATE TABLE IF NOT EXISTS `promotion_province` (
  `promotion_id` int(11) NOT NULL,
  `province_id` char(5) NOT NULL DEFAULT '',
  `status` char(1) NOT NULL DEFAULT 'A',
  KEY `promotion_id_province_id` (`promotion_id`,`province_id`),
  KEY `FK_promotion_province_provice` (`province_id`),
  CONSTRAINT `FK_promotion_province_promotion` FOREIGN KEY (`promotion_id`) REFERENCES `promotion` (`PromotionID`),
  CONSTRAINT `FK_promotion_province_provice` FOREIGN KEY (`province_id`) REFERENCES `province` (`province_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table ooms.promotion_province: ~0 rows (approximately)
/*!40000 ALTER TABLE `promotion_province` DISABLE KEYS */;
/*!40000 ALTER TABLE `promotion_province` ENABLE KEYS */;

-- Dumping structure for table ooms.province
CREATE TABLE IF NOT EXISTS `province` (
  `province_code` char(5) NOT NULL,
  `province` varchar(50) DEFAULT NULL,
  `country_code` char(5) DEFAULT 'LK',
  PRIMARY KEY (`province_code`),
  KEY `FK__country` (`country_code`),
  CONSTRAINT `FK__country` FOREIGN KEY (`country_code`) REFERENCES `country` (`country_code`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table ooms.province: ~9 rows (approximately)
/*!40000 ALTER TABLE `province` DISABLE KEYS */;
INSERT INTO `province` (`province_code`, `province`, `country_code`) VALUES
...
-- Dumping structure for table ooms.screen
CREATE TABLE IF NOT EXISTS `screen` (
  `screen_code` char(16) NOT NULL DEFAULT '',
  `screen_title` varchar(50) DEFAULT NULL,
  `screen_url` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`screen_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table ooms.screen: ~18 rows (approximately)
/*!40000 ALTER TABLE `screen` DISABLE KEYS */;
INSERT INTO `screen` (`screen_code`, `screen_title`, `screen_url`) VALUES
	('home', 'Home', '/'),
	('homejs', 'Home', '/homejs'),
	('login', 'Login', '/login'),
	('merchent', 'Merchent', '/merchent'),
	('merchent-brnd', 'Merchent Brand', ''),
	('merchent-cust', 'Merchent Customer', ''),
	('merchent-local', 'Merchent Location', ''),
	('merchent-prod', 'Merchent Product', ''),
	('merchent-prom', 'Merchent Promo', ''),
	('merchent-serv', 'Merchent Service', ''),
	('merchent-store', 'Merchent Store', ''),
	('merchent-them', 'Merchent Themes', ''),
	('promo-active', 'Our Promotions', '/our-promotions'),
	('promo-add-modify', NULL, NULL),
	('promo-add-new', 'Add New Promotions', '/add-new-promo'),
	('promo-cust-feeds', 'Customer Feed Backs', '/cust-feed-backs'),
	('promo-exp-report', 'Report of Expired Promotions', '/promo-exp-report'),
	('promo-modify', 'Modify Existing Promotions', '/modify-promo'),
	('promo-status', 'Promotional Status', '/promo-status');
/*!40000 ALTER TABLE `screen` ENABLE KEYS */;

-- Dumping structure for table ooms.screen_map
CREATE TABLE IF NOT EXISTS `screen_map` (
  `parent_code` char(16) NOT NULL DEFAULT '',
  `screen_code` char(16) NOT NULL DEFAULT '',
  `order` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`parent_code`,`screen_code`),
  KEY `FK_screen_map_screen_2` (`screen_code`),
  CONSTRAINT `FK_screen_map_screen` FOREIGN KEY (`parent_code`) REFERENCES `screen` (`screen_code`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_screen_map_screen_2` FOREIGN KEY (`screen_code`) REFERENCES `screen` (`screen_code`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table ooms.screen_map: ~13 rows (approximately)
/*!40000 ALTER TABLE `screen_map` DISABLE KEYS */;
INSERT INTO `screen_map` (`parent_code`, `screen_code`, `order`) VALUES
	('merchent', 'merchent-brnd', 4),
	('merchent', 'merchent-cust', 7),
	('merchent', 'merchent-local', 5),
	('merchent', 'merchent-prod', 1),
	('merchent', 'merchent-prom', 3),
	('merchent', 'merchent-serv', 2),
	('merchent', 'merchent-store', 6),
	('merchent', 'merchent-them', 8),
	('merchent-prom', 'promo-active', 1),
	('merchent-prom', 'promo-add-new', 2),
	('merchent-prom', 'promo-cust-feeds', 5),
	('merchent-prom', 'promo-exp-report', 3),
	('merchent-prom', 'promo-status', 4);
/*!40000 ALTER TABLE `screen_map` ENABLE KEYS */;
...
-- Dumping structure for table ooms.stored_text
CREATE TABLE IF NOT EXISTS `stored_text` (
  `screen_code` char(16) NOT NULL DEFAULT '',
  `stored_text` char(50) NOT NULL DEFAULT '',
  PRIMARY KEY (`stored_text`,`screen_code`) USING BTREE,
  KEY `FK_stored_text_screen` (`screen_code`),
  CONSTRAINT `FK_stored_text_screen` FOREIGN KEY (`screen_code`) REFERENCES `screen` (`screen_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table ooms.stored_text: ~59 rows (approximately)
/*!40000 ALTER TABLE `stored_text` DISABLE KEYS */;
INSERT INTO `stored_text` (`screen_code`, `stored_text`) VALUES
	('promo-add-modify', 'AddModPromoActDte'),
	('promo-add-modify', 'AddModPromoBtnRst'),
	('promo-add-modify', 'AddModPromoDesc'),
	('promo-add-modify', 'AddModPromoDisTp1'),
	('promo-add-modify', 'AddModPromoDisTp2'),
	('promo-add-modify', 'AddModPromoDisType'),
	('promo-add-modify', 'AddModPromoDisVal'),
	('promo-add-modify', 'AddModPromoEndDte'),
	('promo-add-modify', 'AddModPromoMaxVal'),
	('promo-add-modify', 'AddModPromoMinVal'),
	('promo-add-modify', 'AddModPromoName'),
	('promo-add-modify', 'AddModPromoPlcDes'),
	('promo-add-modify', 'AddModPromoPlcNam'),
	('promo-add-modify', 'AddModPromoPlcTerm'),
	('promo-add-modify', 'AddModPromoPlcURL'),
	('promo-add-modify', 'AddModPromoPromID'),
	('promo-add-modify', 'AddModPromoTerm'),
	('promo-add-modify', 'AddModPromoURLLnk'),
	('promo-add-new', 'AddPromoBtnSub'),
	('promo-add-new', 'AddPromoFormLnk'),
	('promo-add-new', 'AddPromoTitle'),
	('home', 'BrandTitle'),
	('home', 'CategoriesTitle'),
	('home', 'CatelogMerchentsTab'),
	('home', 'CatelogPromoTab'),
	('home', 'CatelogRentalTab'),
	('home', 'CatelogSalesTab'),
	('home', 'CatelogServiceTab'),
	('home', 'EquipmentTitle'),
	('login', 'Header'),
	('login', 'LoginButton'),
	('merchent', 'LogoutAnchor'),
	('promo-modify', 'ModifyPromoFormLnk'),
	('promo-modify', 'ModifyPromoTitle'),
	('promo-modify', 'ModPromoBtnSub'),
	('promo-active', 'OurPromoTermsCondButton'),
	('promo-active', 'OurPromoTHeadCateg'),
	('promo-active', 'OurPromoTHeadEDate'),
	('promo-active', 'OurPromoTHeadName'),
	('promo-active', 'OurPromoTHeadPhoto'),
	('promo-active', 'OurPromoTHeadSDate'),
	('promo-active', 'OurPromoTitle'),
	('promo-active', 'OurPromoUpdateButton'),
	('login', 'PasswordLabel'),
	('login', 'PasswordPlaceholder'),
	('home', 'PromotionTitle'),
	('login', 'RestButton'),
	('home', 'SearchTabBrand'),
	('home', 'SearchTabCategories'),
	('home', 'SearchTabLocation'),
	('home', 'SearchTabLogin'),
	('home', 'SearchTabPrice'),
	('home', 'SearchTabRegister'),
	('home', 'SearchTabText'),
	('home', 'SearchTabValue'),
	('home', 'ServiceTitle'),
	('login', 'SignupAnchor'),
	...
	('merchent', 'UserWords');
/*!40000 ALTER TABLE `stored_text` ENABLE KEYS */;

-- Dumping structure for table ooms.stored_text_lang_map
CREATE TABLE IF NOT EXISTS `stored_text_lang_map` (
  `stored_text` char(50) NOT NULL,
  `lang_code` char(50) NOT NULL DEFAULT 'en',
  `values` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`stored_text`,`lang_code`),
  KEY `FK_stored_text_lang_map_language` (`lang_code`),
  CONSTRAINT `FK_stored_text_lang_map_language` FOREIGN KEY (`lang_code`) REFERENCES `language` (`lang_code`) ON UPDATE CASCADE,
  CONSTRAINT `FK_stored_text_lang_map_stored_text` FOREIGN KEY (`stored_text`) REFERENCES `stored_text` (`stored_text`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table ooms.stored_text_lang_map: ~57 rows (approximately)
/*!40000 ALTER TABLE `stored_text_lang_map` DISABLE KEYS */;
INSERT INTO `stored_text_lang_map` (`stored_text`, `lang_code`, `values`) VALUES
	('AddModPromoActDte', 'en', 'Active Date'),
	('AddModPromoBtnRst', 'en', 'Reset'),
	('AddModPromoDesc', 'en', 'Summary'),
	('AddModPromoDisTp1', 'en', 'Amount'),
	('AddModPromoDisTp2', 'en', 'Rate'),
	('AddModPromoDisType', 'en', 'Discount Type (select one):'),
	('AddModPromoDisVal', 'en', 'Discount Value'),
	('AddModPromoEndDte', 'en', 'Expire Date'),
	('AddModPromoMaxVal', 'en', 'Maximum Value'),
	('AddModPromoMinVal', 'en', 'Minimum Value'),
	('AddModPromoName', 'en', 'Promotion Title'),
	('AddModPromoPlcDes', 'en', 'Promotional Description'),
	('AddModPromoPlcNam', 'en', 'Promotional Name'),
	('AddModPromoPlcTerm', 'en', 'Terms and Condition'),
	('AddModPromoPlcURL', 'en', 'www.testwebsite.com'),
	('AddModPromoPromID', 'en', 'Promotion ID'),
	('AddModPromoTerm', 'en', 'Terms and Conditions'),
	('AddModPromoURLLnk', 'en', 'URL Link'),
	('AddPromoBtnSub', 'en', 'Add'),
	('AddPromoFormLnk', 'en', 'add-promotion'),
	('AddPromoTitle', 'en', 'Add New Promotion'),
	('BrandTitle', 'en', 'BRAND'),
	('CategoriesTitle', 'en', 'CATEGORIES'),
	('CatelogMerchentsTab', 'en', 'MERCHENTS'),
	('CatelogPromoTab', 'en', 'PROMOS \n& \nDISCOUNTS'),
	('CatelogRentalTab', 'en', 'RENTALS'),
	('CatelogSalesTab', 'en', 'SALES'),
	('CatelogServiceTab', 'en', 'SERVICES'),
	('EquipmentTitle', 'en', 'Equipments'),
	('Header', 'en', 'Login'),
	('LoginButton', 'en', 'Login'),
	('LogoutAnchor', 'en', 'Logout'),
	('ModifyPromoFormLnk', 'en', 'mod-promotion'),
	('ModifyPromoTitle', 'en', 'Modify Promotion'),
	('ModPromoBtnSub', 'en', 'Modify'),
	('OurPromoTermsCondButton', 'en', 'Terms and Conditions'),
	('OurPromoTHeadCateg', 'en', 'Categories'),
	('OurPromoTHeadEDate', 'en', 'Last Date'),
	('OurPromoTHeadName', 'en', 'Promotion'),
	('OurPromoTHeadPhoto', 'en', '	Photos'),
	('OurPromoTHeadSDate', 'en', 'Active Date'),
	('OurPromoTitle', 'en', 'Our Promotions'),
	('OurPromoUpdateButton', 'en', 'Update'),
	('PasswordLabel', 'en', 'Password'),
	('PasswordPlaceholder', 'en', 'Enter your password here'),
	('PromotionTitle', 'en', 'Promos & Discounts'),
	('RestButton', 'en', 'Reset'),
	('SearchTabBrand', 'en', 'BRAND:'),
	('SearchTabCategories', 'en', 'CATEGORIES:'),
	('SearchTabLocation', 'en', 'LOCATION:'),
	('SearchTabLogin', 'en', 'LOGIN'),
	('SearchTabPrice', 'en', 'PRICE:'),
	('SearchTabRegister', 'en', 'REGISTER'),
	('SearchTabText', 'en', 'SEARCH:'),
	('SearchTabValue', 'en', 'ALL'),
	('ServiceTitle', 'en', 'Services'),
	('SignupAnchor', 'en', 'signup now'),
	('SignupLink', 'en', ''),
	('SignupPara', 'en', 'If you are a new user please'),
	('TitleWords', 'en', 'View'),
	('UsernameLabel', 'en', 'Username'),
	('UsernamePlaceholder', 'en', 'Enter your username or email here'),
	('UserWords', 'en', 'Welcome');
/*!40000 ALTER TABLE `stored_text_lang_map` ENABLE KEYS */;
...
-- Dumping data for table ooms.supplier: ~2 rows (approximately)
/*!40000 ALTER TABLE `supplier` DISABLE KEYS */;
INSERT INTO `supplier` (`SupplierID`, `FullName`, `About`, `SupplierType`, `Status`, `UserID`, `CorparationID`) VALUES
	(3, 'Visula Rajakaruna', 'Software Enigner', 'All', 'A', 1, 5),
	(4, 'Mike Bans', 'Data Entry User', 'Data Entery', 'A', 2, 10);
...
-- Dumping data for table ooms.user: ~2 rows (approximately)
...
INSERT INTO `user` (`UserID`, `Username`, `Password`, `Email`, `TelephoneNo`, `Address`, `Status`) VALUES
	...
	(2, 'Mike', '3e0cd7dbf477f6da9831acd7c1d617bc', 'Mike@gmail.com', '', NULL, 'A');
